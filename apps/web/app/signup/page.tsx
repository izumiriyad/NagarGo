...
export default function Signup() {
  return (
    <Suspense fallback={<main className="mx-auto max-w-md px-5 py-16"><div className="skeleton h-8 w-32 rounded-xl mb-4" /><div className="skeleton h-96 rounded-2xl" /></main>}>
      <SignupForm />
    </Suspense>
  );
}
