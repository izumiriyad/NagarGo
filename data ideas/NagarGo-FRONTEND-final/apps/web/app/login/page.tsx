...
function LoginContent() {
  ...
  async function requestCode() {
    ...
    try {
      ...
      // devDisplayCode only exists because this build has no SMS provider yet — see authController.ts.
...
export default function Login() {
  return <Suspense fallback={<main className="mx-auto max-w-md px-5 py-16">Loading sign in…</main>}><LoginContent /></Suspense>;
}
